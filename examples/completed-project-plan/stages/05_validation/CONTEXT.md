...
| `project-calendar.md` | `output/` | Example project calendar artifact for deterministic review |
...
- Confirm the source inventory, project calendar, and decision log outputs pass their artifact-shape rubrics.
