...
Prefer a browser view while keeping the terminal in control? `icm dashboard` shows stage state, review findings, source previews, acceptance-log entries, and copyable review/accept commands without storing hidden state.
